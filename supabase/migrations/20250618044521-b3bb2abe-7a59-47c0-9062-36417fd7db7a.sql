...
CHECK (bayzat_relationship IN ('prospect', 'customer', 'partner'));

-- Add index for better query performance
CREATE INDEX idx_linkedin_queue_bayzat_relationship ON linkedin_queue(bayzat_relationship);

-- Add a comment to document the field
COMMENT ON COLUMN linkedin_queue.bayzat_relationship IS 'Defines relationship with Bayzat: prospect, customer, or partner';
