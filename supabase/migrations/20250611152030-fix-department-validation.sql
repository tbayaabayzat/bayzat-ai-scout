...
-- Update the department validation in both trigger and batch functions
-- to match the webhook's department names
...
-- Update the batch reclassification function with the same department names
